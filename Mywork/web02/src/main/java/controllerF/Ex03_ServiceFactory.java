...
//=> 클래스 외부에서 인스턴스를 생성할 수 없도록 제한 (내부에서 생성해서 공급)
...
public class Ex03_ServiceFactory {
	...
	private Ex03_ServiceFactory() {
		...
		mappings.put("/mUpdate.fo", new Ex05_mUpdate());
	} // 생성자
	...
	// public static Ex03_ServiceFactory getInstance() { return new
	// Ex03_ServiceFactory(); }
