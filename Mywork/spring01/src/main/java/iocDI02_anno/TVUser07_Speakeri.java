...
class LgTVsi implements TV {
	...
	// required false => 해당 인스턴스를 찾지 못했을 때, Exception 발생시키지 않고 null return
...
// 3) IOC/DI 
// => SpeakerA, B 교체 : @Autowired , @Qualifier 이용
@Component("aitv")
...
public class TVUser07_Speakeri {
	...
	public static void main(String[] args) {
		...
		// Test 주의 사항 : 컴포넌트는 패키지 단위로 실행되기 때문에
		//				다른 파일의 컴포넌트를 사용하지 않고 싶다면 주석처리 하자
		// 1. 스프링 컨테이너 생성
