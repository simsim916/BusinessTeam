...
const CustomerQA = () => {
    const [writeQABoxClose, setWriteQABoxClose] = useState(true);
    const [loading, setLoading] = useState(false);
    const [error, setError] = useState(false);

    const bestQAClick = (event) => {
                ...
                <h3>1:1 문의하기</h3>
                    <div id="bestQAForm">
                        ...
                        <ul>
                            <li>1</li>
                            <li>교환/반품/환불</li>
                            <li onClick={bestQAClick}>환불을 신청했는데 환불 기간은 얼마나 소요되나요?</li>
                            <p id="bestQAAnswer">
                        ...
                        <ul>
                            <li>2</li>
                            <li>구매/결제</li>
                            <li onClick={bestQAClick}>상품에 대한 추가 정보를 확인하고 싶습니다.</li>
                            <p id="bestQAAnswer">
                        ...
                        <ul>
                            <li>3</li>
                            <li>배송</li>
                            <li onClick={bestQAClick}>배송중인 상품의 위치를 확인하고 싶어요.</li>
                            <p id="bestQAAnswer">
                        ...
                        <ul>
                            <li>4</li>
                            <li>포인트/할인쿠폰</li>
                            <li onClick={bestQAClick}>포인트는 현금으로 교환할 수 있나요?</li>
                            <p id="bestQAAnswer">
                                ▶ 유료포인트만 환급 가능<br></br>
                                <br></br>
                        ...
                        <ul>
                            <li>5</li>
                            <li>구매/결제</li>
                            <li onClick={bestQAClick}>주문한 상품을 취소하고 싶은데 어떻게 해야 하나요?</li>
                            <p id="bestQAAnswer">
                    ...
                    <div id="customerQABottom">
                        ...
                        <div className="customerQATag">
                            <div>문의 제목</div>
                            <textarea name="title" type="text" placeholder="제목을 입력해주세요." ></textarea>
                        </div>
                        <div className="customerQATag">
                            <div>문의 내용 </div>
                            <textarea id='customerQATag_detail' name="contents" placeholder="내용을 입력해주세요."></textarea>
                        </div>
                        <div className="customerQATag">
                            <div>사진첨부</div>
                    ...
                    <div id="customerQAButton">
                        <button id="customerQACancle">취소하기</button>
