...
//** required 속성
//=> true : 해당 타입의 등록된 빈이 없을때 주입시 익셉션이 발생 (default 값)
...
//  *** @Autowired ***
// => 멤버변수에 애노테이션 적용 하는 방법
// => Autowired 는 멤버별로 적용시켜줘야 한다.
//		@Autowired
//		private Speaker speaker;
//		@Autowired
//		private Student student;
// => Only 전달만 : 생성문 " ~ = new Speaker()" 에서 '='의 역할만 한다는 의미
// 	  그러므로 해당 객체는 반드시 생성 되어 있어야 한다. 
// 	  ( 여기서 해당 객체라 함은 Speaker 생성된 객체를 말한다 / 해당객체가 있어야 멤버변수도 존재할 수 있으니 )
//
// => Autowired 의 실행규칙 
